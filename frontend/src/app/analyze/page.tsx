          ...
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Détection automatique des joueurs et du ballon</p>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold text-white mb-4">
                <span className="text-blue-400">Messi</span> - Analyse Vidéo
              </h2>
              <p className="text-gray-300 max-w-2xl mx-auto">
                Uploadez votre match de football et laissez l'IA détecter automatiquement les joueurs,
                le ballon et générer des statistiques avancées.
              </p>
            </div>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium transition-all ${
                        selectedVideoId === video.id
                          ...
                          : 'bg-black/20 backdrop-blur-sm text-white hover:bg-black/30 border border-white/20'
                      }`}
                    >
